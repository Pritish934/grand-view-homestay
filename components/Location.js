      ...
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        <div className="grid md:grid-cols-2 gap-16">
          <div>
              ...
              {steps.map((step, i) => (
                <li key={step.title} className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-mist/60 text-sm leading-relaxed">{step.text}</p>
                  </div>
                </li>
              ))}
            </ol>
            ...
            <a
              href="https://www.google.com/maps/place/6PVJ+CW+Mawsmai,+Meghalaya"
              target="_blank"
          ...
          <div className="relative rounded-lg overflow-hidden bg-pineLight min-h-[320px]">
            <svg viewBox="0 0 400 400" className="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid slice">
              ...
              <path d="M0,200 Q100,120 200,190 T400,160 V400 H0 Z" fill="#20302A" />
              <path d="M0,260 Q120,210 220,250 T400,230 V400 H0 Z" fill="#16231C" />
              <circle cx="205" cy="150" r="6" fill="#C17A3E" />
              <circle cx="205" cy="150" r="12" fill="#C17A3E" opacity="0.3" />
              <text x="220" y="155" fill="#F1F4F1" fontSize="13" fontFamily="var(--font-manrope)">
                Grand View Homestay
              </text>
            </svg>
          </div>
