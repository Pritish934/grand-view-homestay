...
const mistLayer = {
  ...
  visible: (i) => ({
    opacity: 0,
    y: -40 - i * 20,
    transition: { duration: 2.4, delay: 0.3 + i * 0.25, ease: [0.22, 1, 0.36, 1] },
  }),
};

export default function Hero() {
  return (
    <section id="top" className="relative h-[100svh] min-h-[640px] w-full overflow-hidden bg-pine">
      {/* Sky */}
      ...
      >
        <path d="M0,420 L120,340 260,400 400,300 560,380 720,260 900,360 1080,290 1260,370 1440,310 1440,700 0,700 Z" fill="#2A3B32" opacity="0.55" />
        <path d="M0,480 L160,400 340,460 520,370 700,440 880,360 1060,430 1260,380 1440,440 1440,700 0,700 Z" fill="#20302A" opacity="0.75" />
        <path d="M0,560 L200,500 420,540 640,470 860,530 1080,480 1260,520 1440,490 1440,700 0,700 Z" fill="#16231C" />
      </svg>
      ...
      <div className="relative z-10 h-full max-w-6xl mx-auto px-6 md:px-10 flex flex-col justify-end pb-20 md:pb-28">
        ...
        >
          Mawsmai, Sohra &middot; East Khasi Hills, Meghalaya
        </motion.p>
        <motion.h1
